...
export default function Create() {
  ...
  const handleDetectMaterials = () => {
    ...
    console.log('Detecting materials...', inputData)
    alert('Material detection will be implemented in the next step!')
  }
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            >
              <div className="text-center">
                ...
                <p className="opacity-90">Snap your desk — get instant ideas</p>
              </div>
            </div>
          </div>
        )}
